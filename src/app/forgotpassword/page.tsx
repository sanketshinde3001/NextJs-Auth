  ...
  return (
    ...
    className="p-2 border border-gray-300 rounded-lg mb-4 focus:outline-none focus:border-gray-600 text-black px-4 py-3"
      ...
      <div className='lg:w-1/2 max-lg:w-full p-5 bg-[#131e44] h-screen flex flex-col justify-center items-center '>
        ...
        <p className='text-xl nunito w-full text-left'>Dont worry, it happens to the best of us! Let us get you back on track. Just enter your email address below, and we will send you a link to reset your password.</p>
      </div>
      </div>
    </div>
